...
IntegrateObsMosData <- function(station_id,mos_season_data, obs_season_data, response) { 
  ...
  #for  (atime in analysis_times) {
  #  for (fperiod in forecast_periods) { 
...
FetchDataFP <- function(station_id, atime, fperiod, obs_mos_matrix) {
